            ...
            const renderCompactCard = (bonus: Bonus, idx: number, key: string | number) => {
              ...
              return (
                <div key={key}
                  ...
                  <span className="bht-cpt-card-bet" style={{ position: 'absolute', top: 0, left: 0, zIndex: 3, fontSize: '0.78em', padding: '1px 6px', minWidth: 'unset', maxWidth: 'unset', borderRadius: '0 0 8px 0' }}>{currency}{bet.toFixed(2)}</span>
